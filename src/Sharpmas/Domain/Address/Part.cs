...
/// <summary>Which of a day's two puzzles.</summary>
/// <remarks>
...
/// <summary>Extensions on <see cref="Part"/>, which cannot carry methods.</summary>
public static class PartExtensions
{
    extension(Part part)
    {
        /// <summary>The number the wire expects: <c>1</c> or <c>2</c>.</summary>
        /// <remarks>
    ...
    extension(Part)
    {
        /// <summary>Both parts, in order, for walking a day.</summary>
        /// <remarks>
