...
public abstract record AocVerdict
{
    ...
    /// <summary>
    /// Refused to grade because an answer was submitted too recently.
    /// </summary>
    /// <param name="Wait">
    /// The remaining wait as the site phrased it, such as <c>1m 0s</c>. Kept as
    /// text because it is only ever shown, never counted down.
    /// </param>
    ...
    /// replace this one.
    /// </remarks>
    /// <returns>The verdict as a short phrase.</returns>
